...
chroot_stage() {
    ...
    # After a Perl upgrade, Perl modules must be rebuilt or tools like help2man
    # (needed to build GRUB) break with "BEGIN failed--compilation aborted".
    info "Fixing Perl modules"
    emerge_ app-admin/perl-cleaner
    EMERGE_DEFAULT_OPTS="${EMERGE_EXTRA[*]}" perl-cleaner --all || warn "perl-cleaner reported problems."
